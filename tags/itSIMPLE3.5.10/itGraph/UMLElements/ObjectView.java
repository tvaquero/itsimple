...
public class ObjectView extends VertexView {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1059053957836076019L;
	
	private static final ObjectRenderer RENDERER = new ObjectRenderer();
	...
	public Point2D getPerimeterPoint(EdgeView edge, Point2D source, Point2D p) {
		if (getRenderer() instanceof ObjectRenderer)
			return ((ObjectRenderer) getRenderer()).getPerimeterPoint(this,
					source, p);
