...
public class StateCell extends BasicCell {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3097822727468755418L;
	
	private String internalState = "";
	
	public StateCell(Element state){
		super(state.getChildText("name"));
