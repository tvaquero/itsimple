...
public class EnumerationView extends VertexView {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7427564327101816814L;
	
	private static final EnumerationRenderer RENDERER = new EnumerationRenderer();

	public EnumerationView() {
		super();
	}

	public EnumerationView(Object cell) {
		super(cell);
	}
	...
	public Point2D getPerimeterPoint(EdgeView edge, Point2D source, Point2D p) {
		if (getRenderer() instanceof ClassRenderer)
			return ((ClassRenderer) getRenderer()).getPerimeterPoint(this,
					source, p);
