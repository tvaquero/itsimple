...
public abstract class BasicArc extends DefaultEdge{
	...
	public BasicArc(Object userObject) {
		super(userObject);		
	}	
	...
	public void setRoutePoints(){
		...
		if (data.getChild("graphics").getChildren("position").size() == 0 && loopEdge != null){
			...
			//middle points
			Iterator points = data.getChild("graphics").getChildren("position").iterator();
