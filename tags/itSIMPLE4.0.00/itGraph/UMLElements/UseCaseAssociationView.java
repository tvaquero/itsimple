...
public class UseCaseAssociationView extends BasicAssociationView {
	...
	public UseCaseAssociationView(Object cell) {
		super(cell);
		
		UseCaseAssociation association = (UseCaseAssociation)cell;
		...
		if(sourceRolename != null && targetRolename != null && sourceMultiplicity != null && 
			...
			GraphConstants.setLineBegin(attributes, association.getSourceArrowType());
			GraphConstants.setLineEnd(attributes, association.getTargetArrowType());
