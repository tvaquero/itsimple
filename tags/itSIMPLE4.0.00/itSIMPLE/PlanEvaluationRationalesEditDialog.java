...
public class PlanEvaluationRationalesEditDialog extends JDialog {
	...
	public PlanEvaluationRationalesEditDialog(Frame itSIMPLEFrame, final Element xmlPlan) {
		super(itSIMPLEFrame);

                this.xmlPlan = xmlPlan;
		setTitle("Edit Plan Evaluation Rationales");
		...
		mainPanel.add(new PlanEvaluationRationalesEditPanel(xmlPlan), BorderLayout.CENTER);
