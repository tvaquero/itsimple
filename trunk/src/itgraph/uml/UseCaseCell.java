...
public class UseCaseCell extends BasicCell {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6280595731944176176L;
	
	public UseCaseCell(Element useCase){
		super(useCase.getChildText("name"));
