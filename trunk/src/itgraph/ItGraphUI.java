...
public class ItGraphUI extends BasicGraphUI {
	 ...
	 * on mouse events, and to select individual cells.
	 */
						...
						*/
						...
						if (canCreateAssociation){					
							...
							while(associations.hasNext()){
								...
								// Looking for the sourceClass, or its super-classes, in the current association
								...
								// Looking for the targetClass, or its super-classes, in the current association
						...
						if (canCreateAssociation){
							...
							while(counter < listAssociation.size()){
								...
								//3.1 Analyzing source multiplicity
	...
	*/								//System.out.println("SOURCE->>>> " + currentClassAssociation.getChildText("name")+" - "+listSourceEdges.size());
								...
								//3.2 Analyzing target multiplicity
...
*/										
		...
		public void mousePressed(MouseEvent e) {
                    ...
                    AssociateNeighbour3 frame = null;
						...
						if (!e.isConsumed() && cell != null
								&& !graph.isCellSelected(cell.getCell())) {
                                                    //Object cell = e.getCells()[0];
                                                        selected_obj = cell.getCell();//  getCells()[0];        
			...
			if(graph instanceof ItGraph){
				...
				DefaultTreeModel treeModel = (DefaultTreeModel)ItSIMPLE.getInstance().getItTree().getModel();
                                ...
                                //ItToolBar.enabledNeighborsItem()
                                
                               // if ("objectDiagram".equals(diagram.getName())) {
      
                                 //   if(ItToolBar.associateFrame.showForm() == true){//frame != null){
                               //         ItToolBar.associateFrame.setObject(selected_obj);
                                        //ItToolBar.associateFrame.setObjectDiagram(diagram);
                                        //ItToolBar.associateFrame.setVisible(true);
                                   //}
