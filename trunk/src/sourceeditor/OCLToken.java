 ...
 */ 
public class OCLToken extends Token {
  /**
   ...
   * A boolean value
   */
  public final static int LITERAL_BOOLEAN = 0x340;
  
  /**
   * A null value
   */
  public final static int LITERAL_NULL = 0x350;
   ...
   * A special character 
   */
  public final static int SPECIAL_CHARACTER = 0x600;
   ...
   */
  public OCLToken(int ID, String contents, int lineNumber, int charBegin, int charEnd){
   ...
   */
  public OCLToken(int ID, String contents, int lineNumber, int charBegin, int charEnd, int state){
	this.ID = ID;
