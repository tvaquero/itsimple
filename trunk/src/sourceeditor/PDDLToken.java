 ...
 */ 
public class PDDLToken extends Token {
  /**
   ...
   * A variable
   */
  public final static int VARIABLE = 0x600;
   ...
   */
  public PDDLToken(int ID, String contents, int lineNumber, int charBegin, int charEnd){
   ...
   */
  public PDDLToken(int ID, String contents, int lineNumber, int charBegin, int charEnd, int state){
	this.ID = ID;
  ...
  /** 
   * Checks this token to see if it is a Variable.   
   *
   * @return true if this token is a Operator, false otherwise
   */
