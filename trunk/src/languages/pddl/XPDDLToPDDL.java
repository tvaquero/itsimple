...
public class XPDDLToPDDL {
    ...
    public static String parseXPDDLToPDDL(Element xpddlNode, String identation){
		...
		// 8.1 Action or Process or Event node
		else if(xpddlNode.getName().equals("action") || 
				xpddlNode.getName().equals("process") || 
				xpddlNode.getName().equals("event")){

			//action's or process' or 'event' name
			//pddl = identation + "(:action " + xpddlNode.getAttributeValue("name") + "\n";
			pddl = identation + "(:" +xpddlNode.getName()+" " + xpddlNode.getAttributeValue("name") + "\n";
		...
		// 18. continuous-time
		else if(xpddlNode.getName().equals("time")){
			pddl = xpddlNode.getAttributeValue("id");
		}
