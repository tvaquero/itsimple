...
public class PerspectivesIntroduction {
	public static void main( String[] args ){
		...
		//((Object) frame).destroyOnClose( control );
	...
	private static class ColorFactory implements SingleCDockableFactory, Filter<String>{
		...
		public ColorFactory(){
			colors.put( "Red", Color.WHITE );
			colors.put( "Green", Color.WHITE );
			colors.put( "Blue", Color.WHITE );
			colors.put( "Yellow", Color.WHITE );
