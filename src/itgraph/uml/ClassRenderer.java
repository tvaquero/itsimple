...
public class ClassRenderer extends JComponent implements Serializable,
		CellViewRenderer {
	...
	private JTextPane operatorsPane = null;
	...
	public ClassRenderer() {
        ...
        //attributesPane.setLineWrap(false);
        add(attributesPane, BorderLayout.CENTER);

        // The operations area of the class box
        operatorsPane = new JTextPane(){
                /**
				 * 
				 */
				private static final long serialVersionUID = -6012031181249210993L;
        ...
        operatorsPane.setContentType("text/html");
        //operatorsPane.setPreferredSize(new Dimension(100,20));	
        //operatorsPane.setLineWrap(false);
        add(operatorsPane, BorderLayout.SOUTH);
	...
	public void paint(Graphics g){
        ...
        //{
            attributesPane.setSize(d);
            Rectangle ar = attributesPane.getBounds();
            // inset ?
       ...
       // if (!suppressOperation)
        //{
            operatorsPane.setSize(d);
            Rectangle or = operatorsPane.getBounds();
            // inset ?
            g2d.drawLine(0, or.y, w, or.y);
        //}
